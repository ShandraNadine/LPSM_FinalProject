...
```{r,include = FALSE}
#dataurl <- "https://github.com/ShandraNadine/LPSM_FinalProject/blob/Cleaning/Data/Manumissions_Original.Rdata"
#source (dataurl)
basic <- Manumissions_Original%>%
...
```{r, include = FALSE}
#source("https://github.com/ShandraNadine/LPSM_FinalProject/tree/Cleaning/Data/COF_Original.Rdata")
# 
cofdata <- COF_Original
cofbasic <- cofdata%>%
